<template>
  <main>
    ...
    <div class="home-banner">
      ...
      <div class="informacoes">
        <div class="content text-center">
          <h2>Marcas profissionais pelo melhor custo benefício do mercado. Satisfação garantida.</h2>
          <ul class="items">
            <li>
              <picture>
                <source
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-1.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-banner-1.png"
                  alt
                />
              </picture>
              Ajustes ilimitados
            ...
            <li>
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-banner-7.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-banner-7.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-banner-7.png"
                  alt
                />
              </picture>
              Versões ilimitadas
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-2.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-banner-2.png"
                  alt
                />
              </picture>
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-3.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-4.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-5.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-banner-6.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
      ...
      <div class="new-grid">
        <div class="grid-x">
          <div class="cell text-center">
            <h2>
              Conheça a qualidade do nosso trabalho
            </h2>
            <p>
      ...
      <div class="grid-x align-middle">
        <div class="cell large-6 text-center">
          <picture>
            ...
            />
            <source
              srcset="~/assets/img/img-criacao-marcas-1.jpg"
              type="image/jpg"
            />
            <img
              loading="lazy"
              src="~/assets/img/img-criacao-marcas-1.jpg"
              alt
            />
          </picture>
        </div>
        <div class="cell large-6">
          <h2>
            Sua empresa precisa de uma logo profissional
          </h2>
          <p>
            Uma marca profissional adequada a sua área de atuação e público alvo
            amplia sua probabilidade de fechamento de negócios. A imagem da sua
            empresa, produtos e serviços é fortalecido gerando menor custo na
            aquisição de novos negócios e fidelização de clientes.
          </p>
          <p>
            Uma logo criativa e memorável também aumenta o valor da sua empresa
            e transmite profissionalismo e motivação para toda sua equipe. Conte
            com nossa equipe para elaborar ou atualizar a marca da sua empresa,
            produtos e serviços.
          </p>
        </div>
      </div>
    ...
    <div class="new-grid">
      <div class="grid-x align-middle">
        <div
          class="cell large-12 text-center"
          style="padding: 0 0.9375rem 40px"
        >
          <h2>Ter uma marca profissional faz toda a diferença</h2>
          <p>
            Criar uma marca é uma arte e exibe muito habilidade técnica. Em hipótese alguma pode ser feito de forma amadora.
          </p>
        </div>
        <div class="cell large-3 box-vantagens mobile">
          <picture>
            <source
              srcset="~/assets/img/webp/img-diferenciais-mobile.webp"
              type="image/webp"
            />
            <source
              srcset="~/assets/img/img-diferenciais-mobile.jpg"
              type="image/jpg"
            />
            <img
              loading="lazy"
              src="~/assets/img/img-diferenciais-mobile.jpg"
              alt
            />
          </picture>
        </div>
        <div class="cell large-3 box-vantagens">
          <div class="box-after">
            <picture>
              <source
                srcset="~/assets/img/webp/img-antes-1.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-antes-1.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-antes-1.png"
                  type="image/png"
                />
          ...
          <div class="box-before">
            <picture>
              <source
                srcset="~/assets/img/webp/img-depois-1.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-depois-1.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-depois-1.png"
                  type="image/png"
                />
        ...
        <div class="cell small-12 large-3 box-vantagens">
          <div class="box-after">
            <picture>
              <source
                srcset="~/assets/img/webp/img-antes-2.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-antes-2.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-antes-2.png"
                  type="image/png"
                />
          ...
          <div class="box-before">
            <picture>
              <source
                srcset="~/assets/img/webp/img-depois-2.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-depois-2.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-depois-2.png"
                  type="image/png"
                />
        ...
        <div class="cell large-3 box-vantagens">
          <div class="box-after">
            <picture>
              <source
                srcset="~/assets/img/webp/img-antes-3.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-antes-3.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-antes-3.png"
                  type="image/png"
                />
          ...
          <div class="box-before">
            <picture>
              <source
                srcset="~/assets/img/webp/img-depois-3.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-depois-3.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-depois-3.png"
                  type="image/png"
                />
        ...
        <div class="cell large-3 box-vantagens">
          <div class="box-after">
            <picture>
              <source
                srcset="~/assets/img/webp/img-antes-4.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-antes-4.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-antes-4.png"
                  type="image/png"
                />
          ...
          <div class="box-before">
            <picture>
              <source
                srcset="~/assets/img/webp/img-depois-4.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-depois-4.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-depois-4.png"
                  type="image/png"
                />
        ...
        <div class="cell large-3 box-vantagens">
          <div class="box-after">
            <picture>
              <source
                srcset="~/assets/img/webp/img-antes-5.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-antes-5.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-antes-5.png"
                  type="image/png"
                />
          ...
          <div class="box-before">
            <picture>
              <source
                srcset="~/assets/img/webp/img-depois-5.webp"
                type="image/webp"
              />
            ...
            <div class="box-over">
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-depois-5.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-depois-5.png"
                  type="image/png"
                />
    ...
    <div class="grid-container servicos">
      <div class="grid-x grid-padding-x align-middle">
        <div class="cell text-center titles">
          <h2 class="nomargin">Serviço completo</h2>
          <p>
            Receba também sua logo pronto para usar nas medidas exigidas pelos
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-facebook.webp"
              type="image/webp"
            />
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-instagram.webp"
              type="image/webp"
            />
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-whatsapp.webp"
              type="image/webp"
            />
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-linkedin.webp"
              type="image/webp"
            />
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-twitter.webp"
              type="image/webp"
            />
        ...
        <div class="cell small-6 medium-2 large-2 text-center">
          <picture>
            <source
              srcset="~/assets/img/webp/img-youtube.webp"
              type="image/webp"
            />
      ...
      <div class="grid-container">
        <div class="grid-x">
          <div class="cell text-center files">
            ...
            <p>
              Sua marca entregue pronta para ser usada em alta resolução para
    ...
    <div class="grid-container diferenca">
      <div class="grid-x grid-padding-x">
        <div class="cell text-center">
          <h2 class="nomargin">
            Elementos e conceitos para impactar seus clientes
          </h2>
          <p>
            Ao criar o logotipo da sua empresa ou do seu produto cuidamos de cada
            detalhe para gerar um impacto positivo em seus clientes e equipe.
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            A tipografia merece cuidado especial pois é o principal elemento de
            uma marca
          </p>
        </div>
        <div class="cell large-3">
          <h3>
            <picture>
              ...
              />
              <source
                srcset="~/assets/img/icon-diferenciais-cor.png"
                type="image/png"
              />
              <img
                loading="lazy"
                src="~/assets/img/icon-diferenciais-cor.png"
                alt
              />
            </picture>
            Cor
          ...
          <p>
            É preciso escolher cores adequadas para produzir estímulos corretos
          </p>
        </div>
        <div class="cell large-3">
          <h3>
        ...
        <div class="cell large-3">
          ...
          <p>
            O símbolo é uma representação gráfica para facilitar a identificação
          </p>
        </div>
        <div class="cell large-3">
          <h3>
          ...
          <p>
            O cuidado com os espaçamentos é essencial para comunicar
            corretamente
          </p>
        </div>
        <div class="cell large-3">
        ...
        <div class="cell large-3">
          ...
          <p>
            A textura é um ótimo recurso quando utilizado com cautela e
            criatividade
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            A harmonia entre os elementos é fundamental para demonstrar
            profissionalismo.
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            Uma logo precisa de uma personalidade forte para se diferenciar
          </p>
        </div>
        <div class="cell large-3">
          <h3>
          ...
          <p>
            É preciso de criatividade e autenticidade para diferenciar da
            concorrência
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            Os elementos precisam ser simples e objetivos para oferecer clareza
            na leitura
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            Para alcançar ótimos resultados a marca precisa impactar seu público
            alvo
          </p>
        </div>
        <div class="cell large-3">
          ...
          <p>
            Uma marca forte elaborada com critérios favorece a conexão com o
            consumidor
          </p>
        </div>
        <div class="cell large-3">
          <h3>
            <picture>
              <source
                srcset="~/assets/img/webp/icon-diferenciais-contraste.webp"
                type="image/webp"
              />
              <source
                srcset="~/assets/img/icon-diferenciais-contraste.png"
                type="image/png"
              />
              <img
                loading="lazy"
                src="~/assets/img/icon-diferenciais-contraste.png"
                alt
              />
            </picture>
            Contraste
          ...
          <p>
            O contraste ajuda destacar informações importantes e facilitar
            leitura
          </p>
        </div>
        <div class="cell large-3">
          <h3>
            <picture>
              ...
              />
              <source
                srcset="~/assets/img/icon-diferenciais-alinhamento.png"
                type="image/png"
              />
              <img
                loading="lazy"
                src="~/assets/img/icon-diferenciais-alinhamento.png"
                alt
              />
            </picture>
            Alinhamento
          ...
          <p>
            Alinhar corretamente os elementos melhora a percepção do consumidor
          </p>
        </div>
        <div class="cell large-3">
          <h3>
            <picture>
              ...
              />
              <source
                srcset="~/assets/img/icon-diferenciais-equilibrio.png"
                type="image/png"
              />
              <img
                loading="lazy"
                src="~/assets/img/icon-diferenciais-equilibrio.png"
                alt
              />
            </picture>
            Equilíbrio
          ...
          <p>
            Equilibrar o peso das informações é chave para representar
            estabilidade
          </p>
        </div>
      </div>
        ...
        <div class="grid-x grid-padding-x align-middle">
          ...
          <div class="cell large-6">
            <n-link to="/video">
              <picture>
                <source
                  srcset="~/assets/img/webp/video-criacao-de-logos.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/video-criacao-de-logos.jpg"
                  type="image/png"
                />
                <img
                  loading="lazy"
    ...
    <div class="grid-container brindes">
      <div class="grid-x grid-padding-x text-center ">
        <div class="cell title">
          ...
          <p>Que tal turbinar sua logo com alguns materiais de divulgação?</p>
        </div>
        <div class="cell medium-3 itens">
          <picture>
            <source
              srcset="~/assets/img/webp/cartao-visita.webp"
              type="image/webp"
            />
            <source
              srcset="~/assets/img/cartao-visita.png"
              type="image/png"
            />
            <img
              loading="lazy"
              src="~/assets/img/cartao-visita.png"
              alt
            />
          </picture>
          <h3>Cartão de visitas</h3>
          <p>Entregue um cartão de visitas de qualidade, isso gera um grande impacto e ajuda fidelizar clientes.</p>
        </div>
        <div class="cell medium-3 itens">
          <picture>
            <source
              srcset="~/assets/img/webp/timbrado.webp"
              type="image/webp"
            />
            <source
              srcset="~/assets/img/timbrado.png"
              type="image/png"
            />
            <img
              loading="lazy"
              src="~/assets/img/timbrado.png"
              alt
            />
          </picture>
          <h3>Papel timbrado</h3>
          <p>Disponibilize suas propostas e contratos  com um papel timbrado personalizado com sua logo.</p>
        </div>
        <div class="cell medium-3 itens">
          <picture>
            <source
              srcset="~/assets/img/webp/envelope.webp"
              type="image/webp"
            />
            <source
              srcset="~/assets/img/envelope.png"
              type="image/png"
            />
            <img
              loading="lazy"
          ...
          <h3>Envelope</h3>
          <p>Envie correspondências personalizadas em um envelope com sua identidade visual.</p>
        </div>
        <div class="cell medium-3 itens">
          <picture>
            <source
              srcset="~/assets/img/webp/camiseta.webp"
              type="image/webp"
            />
            <source
              srcset="~/assets/img/camiseta.png"
              type="image/png"
            />
            <img
              loading="lazy"
          ...
          <h3>Camiseta</h3>
          <p>Entregue uma camistea personalizada com sua marca para sua equipe e clientes.</p>
        </div>   
      </div>
    </div>
    <div class="depoimentos">
      <div class="grid-container">
        <div class="grid-x grid-padding-x text-center ">
          <div class="cell title">
            <h2 class="white">Marca criada, expectativa superada</h2>
            <p class="white">Conheça alguns dos nossos clientes satisfeitos com o serviço realizado.</p>
          </div>
          <div class="cell carousel">
            <div class="box">              
              <picture>
                <source
                  srcset="~/assets/img/webp/depoimento-belvedere.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/depoimento-belvedere.jpg"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  class="thumb"
                  src="~/assets/img/depoimento-belvedere.jpg"
                  alt
                />
              </picture>
              <p class="author">Izabel Iwamura - Espaço Belvedere</p>
              <p class="testimonials">
Vocês são criativos, lógicos e profissionais competentes! Parte do nosso sucesso devemos aos profissionais competentes da Evonline que conseguiram compreender nossos anseios.</p>
            </div>
            <div class="box">              
              <picture>
                <source
                  srcset="~/assets/img/webp/depoimento-renan-melo.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/depoimento-renan-melo.jpg"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  class="thumb"
                  src="~/assets/img/depoimento-renan-melo.jpg"
                  alt
                />
              </picture>
              <p class="author">Renan Melo - Melo Arquitetura</p>
              <p class="testimonials">Um excelente atendimento assim como o serviço prestado e o projeto desenvolvido, digno de recomendação e referência. Obrigado a toda agência!</p>
            </div>
            <div class="box">              
              <picture>
                <source
                  srcset="~/assets/img/webp/depoimento-fabiana.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/depoimento-fabiana.jpg"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  class="thumb"
                  src="~/assets/img/depoimento-fabiana.jpg"
                  alt
                />
              </picture>
              <p class="author">Fabiana Beltrame - Fotografia</p>
              <p class="testimonials">Atenciosos, pontuais e super profissionais! Obrigada, Evonline! Amei meu projeto!</p>
            </div>
            <div class="box">              
              <picture>
                <source
                  srcset="~/assets/img/webp/depoimento-lecheta.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/depoimento-lecheta.jpg"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  class="thumb"
                  src="~/assets/img/depoimento-lecheta.jpg"
                  alt
                />
              </picture>
              <p class="author">Edson Lecheta - HD Consult</p>
              <p class="testimonials">"Admiro a capacidade empreendedora, maturidade de gestão e pela busca constante de melhores resultados… Parabéns à toda a equipe, sempre..."</p>
            </div>            
          </div>
        </div>
      </div>
    </div>
    <div class="grid-container investimento">
      <div class="grid-x text-center">
        <div class="cell">
          <h2 class="nomargin">Garantimos sua satisfação! Fale conosco</h2>
          <p>
          ...
          <ul class="items">
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-1.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-condicao-1.png"
                  alt
                />
              </picture>
              Ajustes ilimitados
            ...
            <li>
              <picture>
                <source
                  srcset="~/assets/img/webp/icon-condicao-7.webp"
                  type="image/webp"
                />
                <source
                  srcset="~/assets/img/icon-condicao-7.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-condicao-7.png"
                  alt
                />
              </picture>
              Versões ilimitadas
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-2.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
                  src="~/assets/img/icon-condicao-2.png"
                  alt
                />
              </picture>
              Entrega rápida 72 horas
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-3.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-4.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-5.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
            ...
            <li>
              <picture>
                ...
                />
                <source
                  srcset="~/assets/img/icon-condicao-6.png"
                  type="image/png"
                />
                <img
                  loading="lazy"
    ...
    .banner {
      ...
      @media screen and (min-width: 1240px) {
        .cell {
          position: relative;
          &:after {
            content: url("~assets/img/webp/img-banner-1.webp");
            position: absolute;
            left: 90px;
            bottom: 15px;
          }
          &:before {
            content: url("~assets/img/webp/img-banner-2.webp");
            position: absolute;
            right: 135px;
            bottom: -40px;
          }
...
@media screen and (max-width: 767px) {
  ...
  .home-banner {
    ...
    .informacoes {
      .content {
        padding: 35px 0.9375rem 15px !important;
      }
    }
    .items {
      flex-wrap: wrap;
...
@media screen and (min-width: 768px) {
  main {
    .home-banner {
      background-image: url("~assets/img/img-banner-home.jpg");
