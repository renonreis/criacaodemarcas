      ...
      <div class="grid-container">
        <div class="grid-x align-bottom text-center">
          <div class="cell large-12" style>
            <h1>Guia completo para criar uma marca de sucesso</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="grid-container conteudo-post">
      <div class="grid-x align-middle text-justify">
        <p>
        ...
        <p>
          Uma marca reconhecida e amada é um dos ativos mais valiosos que sua empresa pode ter. Mesmo as pequenas empresas podem buscar diferenciação com uma <b>criação de marca</b> forte e sólida. E isso vai muito além de um logotipo bonito, envolve também a percepção global do seu negócio pelos clientes, pois é capaz de gerar valor em todos os pontos de contato.
        </p>
        <p>
        ...
        <p>
          Por isso, se você deseja ter um negócio sólido e de longo prazo este guia é para você. Nele é possível encontrar todos os aspectos que devem ser considerados para a <b>criação de uma marca</b> de sucesso.
          <br/>
          <br/>
        </p>
        <h2>
        ...
        <p class="bordered text-center">
          <b>É correto falar logomarca?</b>
          <br/><br/>
          Para entender a diferença, é importante analisar a etimologia da palavra Logomarca. Ela é formada por duas palavras: logo + marca.
          “Logos” vem do grego e significa “significado, conceito”. “Marca” origina-se da palavra germânica ‘marka’ e tem o mesmo significado do termo logo. Por isso, logomarca significaria ‘Significado do significado” ou “Conceito do conceito’. Portanto, utilizar o termo não é a forma mais correta, apesar de sua popularidade.
        </p>
        <p>
        ...
        <p>
          <b>a) A importância do propósito da sua marca (O porquê)</b><br/>
        ...
        <p>
          Esse propósito, normalmente, vem junto com a <b>criação de logomarca para a empresa</b> e acaba se tornado uma tagline ou slogan da marca. Um bom exemplo de propósito é o da marca Airbnb, uma plataforma de compartilhamento de estadia e atividades presente no mundo todo.
        </p>
        <picture>
          <source
            srcset="~/assets/img/postagem/airbnb-outdoor.webp"
            type="image/webp"
          />
          <source
            srcset="~/assets/img/postagem/airbnb-outdoor.jpg"
            type="image/png"
          />
          <img
            loading="lazy"
            src="~/assets/img/postagem/airbnb-outdoor.jpg"
            alt
          />
        </picture>
        <p>
        ...
        <p>
          O autor inglês Simon Sinek publicou o livro <i>Starts with Why</i>, lançado no Brasil com o nome de “Por quê? Ele ficou mundialmente famoso por apresentar em uma palestra do TED uma teoria denominada <b>“The Golden Circle”</b>, que começa definindo o porquê as empresas fazem o que fazem.
        </p>
        <p>
        ...
        <p>
          <em>
            <b>Why:</b> explica o porquê sua empresa faz o que faz, qual é o propósito dela, ou seja, o significado de tudo. Por que sua empresa existe? Qual é a causa maior?? Qual é a real motivação por trás do seu negócio?<br/>
            <b>How:</b> diz respeito ao sua empresa tira os planos do papel. Esse ponto pode ser entendido como os objetivos, as ações práticas e concretas que farão a empresa alcançar seu propósito. Aqui entram as crenças e valores que a marca tem.<br/>
            <b>What:</b> O que sua empresa  efetivamente faz ou vende e o que ela poderá oferecer no futuro, até onde ela pode crescer e em qual direção pode ser projetada?.
          </em>
        </p>
        <p>
          <iframe width="800" height="450" src="https://www.youtube.com/embed/POfQlg0V0Cc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </p>
        <p>
          <b>b) Entendendo a promessa da Marca (Como):</b><br/>
        ...
        <p>
          <b>c) Detectando os atributos da Marca (o que a diferencia?)</b><br/>
        ...
        <p>
          O <b>tom</b> consiste na cor base escolhida. <br/>
          A <b>saturação</b> é a intensidade dessa cor. <br/>
          O <b>valor</b> é quão clara ou escura ela é. <br/>
        </p>
        <p>
        ...
        <p>
          Além disso, é necessário entender as possíveis combinações entre cores. Uma paleta com cores opostas é chamadas de <b>"complementar"</b>, com combinações como o violeta com amarelo, azul com laranja ou verde com vermelho. Normalmente o uso de cores complementares revela maior contraste por serem duas cores opostas, e isso pode chamar a atenção dos olhos, mas deve ser combinada com cuidado para não gerar atrito e incômodo visual.
        </p>
        <p>
          Uma paleta <b>"monocromática"</b> é aquela que possui vários tons de uma mesma cor, como uma paleta feita de vários tons de rosa. Pode ser uma opção forte pois irá atrelar toda a imagem visual de uma marca com uma cor só, e pode ser facilmente lembrada por clientes. Da mesma forma que a complementar, deve ser uma combinação bem desenvolvida ou se tornará uma paleta insossa.
        </p>
        <p>
          A combinação <b>"análoga"</b> é composta por cores próximas, como é o caso do laranja e vermelho. É uma combinação mais inovadora que a monocromática e menos arriscada que a complementar, mas ainda tem de ser bem aplicada para que haja um equilíbrio, preferencialmente escolhendo uma cor para se destacar acima das demais.
        </p>
        <p>
        ...
        <p>
          <b>d) O mundo da tipografia (falando entre as linhas).</b><br/>
        ...
        <p>
          Alguns conceitos básicos que precisam ser levados em consideração na hora da escolha da tipografia para <b>criação de marca e logotipo</b> são:
        </p>
        <p>
          <em>Classificação das Fontes:</em> existem milhares de fontes por aí, porém todas elas se encaixam em seis categorias básicas: estilo antigo, moderno, serifa grossa, sem serifa, manuscrito e decorativo.
        </p>
        <p>
          A primeira categoria, o <span class="antigo">estilo antigo</span> é a fonte perfeita para um texto longo, onde você precisa que uma audiência preste atenção no que está sendo dito por bastante tempo. Livros costumam usar fontes neste formato. Por ser um estilo desenvolvido há séculos e pela escrita à mão com ajuda de uma pena, é uma fonte que possui este aspecto de “invisibilidade”. Não chama muita atenção, mas prende muita atenção para leitura. É uma fonte que sempre possui serifa (estes pequenos detalhes ao na extremidade das letras) e tem uma transição do grosso ao fino nos seus traços.
        </p>
        <p>
          Em seguida, com o <span class="moderno">estilo moderno</span> nos deparamos com um estilo mais “mecânico” de fonte, mais frio e elegante. Por possuir uma aparência muito forte, não é o estilo indicado para um texto corrido, pois pode torná-lo cansativo. É a fonte indicada se você procura passar uma mensagem rápida ou criar um título marcante. É ideal usá-la em um tamanho grande.
        </p>
        <p>
          O estilo de <span class="moderno">serifa grossa</span>, assim como o estilo antigo, é ótimo para textos extensos, por conta de seus traços grossos. O peso de cada letra deste estilo é igual, então é um bom estilo para se usar em pôsteres e peças de propaganda com maior seriedade.
        </p>
        <p>
        ...
        <p>
          ...
          <span style="font-size: 14px">e nem viu num primeiro momento que tinha algo escrito aqui.</span>
        </p>
        <p>
          <em>Composição Gráfica:</em> este é o último conceito básico para escolher uma tipografia de sucesso. Na composição gráfica, o designer irá ajustar a composição do texto com os outros elementos. A regra é definida de acordo com o espaço disponível para acomodar o texto, que podem ser os seguintes: <em>alinhamento à esquerda, alinhamento à direita, centralizado e justificado.</em>
        </p>
        <p>
        ...
        <p>
          <b>e) A frase que resume tudo: seu slogan</b><br/>
          <em>"De mulher pra mulher, Marisa"</em>. Se você automaticamente começou a cantar a musiquinha e já sabia de qual marca ela era sem nem precisar chegar ao final, já sabe do que se trata um slogan e a força que ele tem na identidade da sua marca. Os slogans normalmente são escolhidos como apoio para a comunicação da marca, principalmente em momentos em que só o logotipo não é suficiente.
        </p>
        <p>
...
@import url('https://fonts.googleapis.com/css2?family=Bodoni+Moda&family=Caveat&family=Press+Start+2P&display=swap');
