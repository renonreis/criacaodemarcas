<template>
  <ul class="accordion" data-accordion>
    ...
    <li class="accordion-item" data-accordion-item>
      <a href="#!" class="accordion-title">Os direitos dos arquivos são meus? Posso divulgar?</a>
      <div class="accordion-content" data-tab-content>
        <p>
          É importante questionar o quanto a execução dos pontos do
          programa assume importantes posições no estabelecimento de
    ...
    <li class="accordion-item" data-accordion-item>
      <a href="#!" class="accordion-title">Se eu não gostar, posso pedir ajustes ou novas opções?</a>
      <div class="accordion-content" data-tab-content>
        <p>
          É importante questionar o quanto a execução dos pontos do
          programa assume importantes posições no estabelecimento de
